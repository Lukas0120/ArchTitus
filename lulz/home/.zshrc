...
alias makeconf="sudo micro /etc/makepkg.conf"
alias pacconf="sudo micro /etc/pacman.conf"
alias yays="yay -Ss"
alias remf="sudo rm -R"
alias yayr="yay -R"
alias pacr="sudo pacman -R"
alias zshconf="sudo micro ~/.zshrc"
alias kerneledit="cd ~/git-repos/linux-cachyos/linux-cachyos-cacule && micro PKGBUILD"
...
alias aliasconf="sudo micro ~/.oh-my-zsh/custom/aliases.zsh"
alias grubedit="sudo micro /etc/default/grub"
alias aex="asp export"
alias yas="yay -S"
alias boreedit="cd ~/git-repos/linux-cachyos/linux-cachyos-bore && micro PKGBUILD"
alias sysstatus="sudo systemctl status"
alias syse="sudo systemctl enable"
alias syss="sudo systemctl start"
alias sysd="sudo systemctl disable"
alias journal="sudo micro /etc/systemd/journald.conf"
alias katten="micro ~/.config/kitty/kitty.conf"
alias piconf="micro ~/.config/picom.conf"
alias paco="sudo pacman -U *.pkg.tar.zst --overwrite '*'"
alias killpi="kill -9 $(pidof picom)"
alias alaconf="micro ~/.config/alacritty/alacritty.yml"
...
alias pollyconf="sudo micro /etc/makepkg-polly.conf"
# omz
alias ..="cd ../"
...
alias sysconf="sudo micro /etc/sysctl.d/99-cachyos-settings.conf"
